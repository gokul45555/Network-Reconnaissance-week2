...
theHarvester v4.10.1	OSINT gathering and subdomain enumeration
Nmap 7.991	Network scanning and host discovery
...
1. Multiple subdomains were discovered through OSINT sources.


2. Several theHarvester sources required API keys.


3. The Baidu source returned no useful results.


4. The Nmap/Zenmap ping sweep identified 2 live hosts on the lab subnet.
...
⭐ This project documents my hands-on learning in penetration testing and network reconnaissance.
